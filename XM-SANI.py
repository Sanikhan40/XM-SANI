...
princp=[]
try:
	prox= requests.get('https://github.com/Sanikhan40/XM-SANI/blob/main/approval.text').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Sanikhan40/XM-SANI/blob/main/approval.text').text
		ua=open('.bbnew.txt','w')
